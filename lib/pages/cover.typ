...
#let cover_page(
  ...
  place(
    ...
    dx: -10mm,
    dy: 10mm,
    image("../assets/logo.svg", width: 200pt)
  )
  ...
  place(
    ...
    box(
      align(
        left,
        stack(
          text("PARTNERBETRIEB", size: 10pt, weight: "bold"),
          v(3mm),
          line(start: (0pt, 0pt), length: 25pt, stroke: 0.5mm),
          v(5mm),
          image("../assets/svlfg_logo.svg", width: 164pt),
          v(5mm),
          text("Sozialversicherung für Landwirtschaft,", size: 9pt, weight: "bold"),
          v(2mm),
          text("Forsten und Gartenbau", size: 9pt, weight: "bold"),
          v(2mm),
          text("Weißensteinstr. 70 - 72", size: 9pt),
          v(2mm),
          text("34131 Kassel", size: 9pt),
        )
      )
    )
  )
    ...
    stack(
      ...
      if submission-date != none {
        stack(
          ...
          text(
            translations.submitted + ": " + submission-date.display("[day]. Juni [year]"),
            size: 10pt,
          ),
        )
      },
